...
describe('country', () => {
  it('can get continent', async () => {
    ...
    const country = new Country('ARGENTINA', null, null);
  ...
  it('can get null continent with invalid country', async () => {
    ...
    const country = new Country('INVALID_COUNTRY', null, null);
    const continent = country.getContinent();
  ...
  it('can check if two countries are neighbours', async () => {
    ...
    const country = new Country('BRASIL', null, null);
  ...
  it('can check if a country can attack another', async () => {
    ...
    const attacker = new Country('BRASIL', null, { player: players[0], troops: 2, newTroops: 0 });
    const defender = new Country('ARGENTINA', null, { player: players[1], troops: 2, newTroops: 0 });
  ...
  it('can check a country can not attack another if they belong to the same player', async () => {
    ...
    const attacker = new Country('BRASIL', null, { player: players[0], troops: 2, newTroops: 0 });
    const defender = new Country('ARGENTINA', null, { player: players[0], troops: 2, newTroops: 0 });
    const canAttak = attacker.canAttack(defender);
  ...
  it('can check a country can not attack another if they are not neighbours', async () => {
    ...
    const attacker = new Country('BRASIL', null, { player: players[0], troops: 2, newTroops: 0 });
    const defender = new Country('OREGON', null, { player: players[1], troops: 2, newTroops: 0 });
    const canAttak = attacker.canAttack(defender);
  ...
  it('can check a country can not attack with less than 2 troops', async () => {
    ...
    const attacker = new Country('BRASIL', null, { player: players[0], troops: 1, newTroops: 0 });
    const defender = new Country('ARGENTINA', null, { player: players[1], troops: 2, newTroops: 0 });
    const canAttak = attacker.canAttack(defender);
