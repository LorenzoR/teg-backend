...
class CountryService {
  ...
  public static getContinent(countryKey: string): string | null {
  ...
  public static canAttack(source, target): boolean {
    // Same player
  ...
  public static areNeighbours(source, target): boolean {
    return Neighbours[source].includes(target);
  }

  public static getNeighbours(country): [] {
