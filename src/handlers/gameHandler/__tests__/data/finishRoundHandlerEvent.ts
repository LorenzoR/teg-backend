...
export const finishRoundHandlerEvent = (gameId: string, connectionId: string, playerColor: string): APIGatewayProxyEvent => ({
    body: `{"data":{"gameId":"${gameId}","playerColor":"${playerColor}"},"action":"finishRound"}`,
