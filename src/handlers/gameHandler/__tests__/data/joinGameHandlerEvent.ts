...
export const joinGameHandlerEvent = (gameId: string, connectionId: string, username: string, color: string): APIGatewayProxyEvent => ({
    body: `{"data":{"gameId":"${gameId}","username":"${username}","color":"${color}"},"action":"joinGame"}`,
