...
export const connectHandlerEvent = (gameId: string, connectionId: string, playerColor: string): APIGatewayProxyEvent => ({
    body: `{"data":{"gameId":"${gameId}","color":"${playerColor}"},"action":"finishRound"}`,
