...
export const finishTurnEvent = (gameId: string, connectionId: string): APIGatewayProxyEvent => ({
    body: `{"data":{"gameId":"${gameId}","username":"azul","playerColor":"blue"},"action":"joinGame"}`,
